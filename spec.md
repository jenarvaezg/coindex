...
1. **`data/collection-catalogs/*.json` — 60 catálogos curados** (el activo más caro de
...
- **60 catálogos** con 1.084 miembros: 30 abiertos y 30 cerrados. Por versión de esquema, 35
