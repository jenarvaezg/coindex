...
/**
 * Where the five switches of the export sheet are remembered (#228).
 *
 * One property behind an interface, like [ShelfStore]: what has to be checkable is *when* it is
 * written — on the export and never on a toggle — and that is a rule about the gesture rather than
 ...
 */
class StoredNotebook(context: Context) : NotebookStore {
    private val prefs = context.getSharedPreferences(PREFS, Context.MODE_PRIVATE)

    override var options: NotebookOptions
