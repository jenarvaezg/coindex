...
object Routes {
    ...
    const val PROPOSAL = "proposal?family={family}&weight={weight}&finish={finish}"
    ...
    /**
     * A proposal is addressed by the same three canonical parts that its disposition is stored
