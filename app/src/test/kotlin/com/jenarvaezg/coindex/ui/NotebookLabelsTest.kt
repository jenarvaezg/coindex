...
class NotebookLabelsTest {
    ...
    fun `progress counts the page being drawn and names the collection`() {
        ...
        assertEquals("Página 84 de 84 · Venezuela reales", notebookProgressLabel(83, 84, "Venezuela reales"))
    ...
    fun `the closing message counts the photographs that never arrived`() {
        assertEquals("Cuaderno completo exportado · 84 páginas", notebookExportMessage(84, 1_044, 1_044))
        assertEquals(
